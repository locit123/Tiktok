...
export const ActiveUserIcon = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            className={className}
            ...
            viewBox="0 0 16 16"
        >
            <path d="M14 8c0-.28-.22-.5-.5-.5H5.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L5.707 8.5H13.5a.5.5 0 0 0 .5-.5z"></path>
        </svg>
    );
};
...
export const CloseModal = ({ className, width = '2.5em', height = '2.5rem' }) => {
    return (
        <svg
            ...
            width={width}
            height={height}
            class="css-1anes8e-StyledIcon e1gjoq3k5"
            data-e2e=""
            viewBox="0 0 48 48"
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
